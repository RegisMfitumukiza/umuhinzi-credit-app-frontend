    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Review loan applications directed to your institution and disburse approved loans.
        </p>
      </div>
        ...
        <Card>
          ...
          {appsLoading ? (
            ...
            <CardContent className="py-10 text-center text-sm text-muted-foreground">
              No loan applications for your institution yet.
            </CardContent>
          ) : (
      ...
      {tab === "loans" && (
        <Card>
          ...
          {loansLoading ? (
            ...
            <CardContent className="py-10 text-center text-sm text-muted-foreground">
              No loans for your institution yet.
            </CardContent>
          ) : (
            <div className="divide-y">
              {loans.map((loan) => (
                <LoanItem key={loan.id} loan={loan} canDisburse />
              ))}
            </div>
          )}
...
export default InstitutionLoansPage;
